...
const endpoints = {
  aniimo: {
    ...
    url: `${NOCODB_URL}/medh4olnqzb8tj3/records?pageSize=9999`,
  },
  elements: {
    path: './src/data/elements.json',
    url: `${NOCODB_URL}/m3rdnw6s4n00lel/records?pageSize=9999`,
  },
  roles: {
    path: './src/data/roles.json',
    url: `${NOCODB_URL}/m1aqmiqn9a6wpna/records?pageSize=9999`,
  },
  forms: {
    path: './src/data/forms.json',
    url: `${NOCODB_URL}/m5fge5s0sosoxy7/records?pageSize=9999`,
  },
};
